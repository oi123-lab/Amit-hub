...
local Paragraph = Tab1:AddParagraph({"ATUALIZAÇÕES📜🛠", "⚒A TAB DE BEM VINDO REWORK!,BOOMBOX ADICIONADA,MELHOR FLING COUCH DO BROOKHAVEN ADICIONADO, HOUSE BAN KILL ADICIONADO, COMBATE SH V4 ADICIONADO,NOVA UI,DARK BLADE ADICIONADA⚔"})
